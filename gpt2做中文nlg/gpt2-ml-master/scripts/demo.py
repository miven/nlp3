...
import sys
sys.path.append("..")
from train.modeling import GroverModel, GroverConfig, sample   # 有时候代码找不到库包,设置一下source目录,把没用的source 目录取消掉即可.
...
args.ckpt_fn='model.ckpt-220000.data-00000-of-00001.data-00000-of-00001'
