...
def main():
    ...
    parser.add_argument('--model_config', default='config/model_config_small.json', type=str, required=False,
                        help='模型参数')
    parser.add_argument('--tokenizer_path', default="tokenizations/clue-vocab.txt", type=str, required=False, help='词表路径')
...
#=================配置自己的参数.
    ...
    args.tokenizer_path ="tokenizations/clue-vocab.txt"

    tokenizer = tokenization.FullTokenizer(vocab_file=args.tokenizer_path, do_lower_case=True)
