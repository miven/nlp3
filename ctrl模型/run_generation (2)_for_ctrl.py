...
# 这玩应是牛逼啊, 封装很好,直接跑代码即可, 权重都自动下载好了!!!!!!!!!!!!!!!!!!!
    ...
    if requires_preprocessing:  # 是否模型需要预处理.
